    ...
    render() {
        return (
            <svg className="icon-python" xmlns="http://www.w3.org/2000/svg" width={this.props.width}
                 height={this.props.height} viewBox="0 0 512 512" aria-labelledby="title" {...this.props}>
    ...
    render() {
        return (
            <svg className="icon-coda" xmlns="http://www.w3.org/2000/svg"
                 height={this.props.height} viewBox="0 0 200 200" aria-labelledby="title" {...this.props}>
    ...
    render() {
        return (
            <svg className="icon-logo" xmlns="http://www.w3.org/2000/svg" width={this.props.width}
                 height={this.props.height} viewBox="0 0 550 250" aria-labelledby="title" {...this.props}>
