...
export const NCIcon = React.createClass({
    propTypes: {
        icontype: React.PropTypes.oneOf(['python', 'lilypond', 'coda']),  // 'coda' is default
...
export const NCLogo = React.createClass({
    propTypes: {
